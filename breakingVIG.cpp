// vig_console.cpp : Defines the entry point for the console application.
//If using a FILE to load this program PLEASE change the file NAME AND PATH in "the_file" variable
...
char the_file[] = "D:\\01_OnlineJ\\42_breakingVignere\\cipher8.txt"; /*THIS IS FILE TO LOAD, please change according to your location also use DOUBLE "//" instead of single "/" */
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	_strupr(cipher); //covert all the Alphabets in Capital
